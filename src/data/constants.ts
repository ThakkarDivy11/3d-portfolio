...
using use = useUsing("use")`,
  ...
  [SkillNames.PRETTIER]: {
    ...
    name: "Postman",
    label: "Postman",
    shortDescription: "A tool to test APIs easily without writing frontend code",
    color: "#f7b93a",
  ...
  [SkillNames.VIM]: {
    ...
    name: "Render",
    label: "Render",
    shortDescription: "a cloud platform to deploy and host apps, APIs, and databases easily.",
    color: "#e34c26",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/render/render-plain.svg",
  },
  [SkillNames.VERCEL]: {
    id: 24,
    name: "vercel",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Dec 2025",
    endDate: "Present",
    title: "Web and AI Developer",
    company: "Commerciax (Neweb.AI)",
    description: [
      "Web and AI Developer experienced in MongoDB, Express.js, React, Node.js, and WordPress, with hands-on knowledge of Large Language Models (LLMs) and RAG-based systems.",
      "Focused on developing scalable applications and implementing AI-powered features.",
    ],
    skills: [
      SkillNames.MONGODB,
      SkillNames.EXPRESS,
  ...
  },
  {
    ...
    company: "InnovateMR",
    description: [
      "Developed web applications using MongoDB, Express.js, Angular, and Node.js.",
      "Collaborated with the team to deliver full-stack features in a real-world agile environment.",
    ],
    skills: [
      SkillNames.MONGODB,
      SkillNames.EXPRESS,
